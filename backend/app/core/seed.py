...
DEFAULT_PERMISSIONS = [
    ...
    {"key": "shipments.view", "label": "Ver envíos", "category": "Envíos", "action": "Ver/listar"},
    {"key": "shipments.create", "label": "Crear envíos", "category": "Envíos", "action": "Crear"},
    {"key": "shipments.edit", "label": "Editar envíos", "category": "Envíos", "action": "Editar"},
    {"key": "shipments.add_orders", "label": "Agregar pedidos a envíos", "category": "Envíos", "action": "Asignar pedidos"},
    {"key": "shipments.dispatch", "label": "Despachar envíos", "category": "Envíos", "action": "Despachar"},
    {"key": "shipments.cancel", "label": "Cancelar envíos", "category": "Envíos", "action": "Cancelar"},
    ...
    {"key": "orders.submit", "label": "Enviar pedido a planta", "category": "Ventas / Pedidos", "action": "Enviar a planta"},
