...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("draft", "submitted", "approved", "prepared", "closed", 
name="orderstatus"), nullable=False, server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "sent", "delivered", name="remitostatus"), 
nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("sku_id", sa.Integer(), sa.ForeignKey("skus.id"), nullable=False),
        sa.Column("deposit_id", sa.Integer(), sa.ForeignKey("deposits.id"), nullable=False),
        sa.Column("movement_type", sa.Enum("production", "consumption", "adjustment", "transfer", 
"remito", "merma", name="movementtype"), nullable=False),
        sa.Column("quantity", sa.Float(), nullable=False),
